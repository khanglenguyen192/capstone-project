          ...
          <ul class="metismenu" id="side-menu">
            ...
            <li>
              <a href="javascript: void(0);">
                <i class="fi-layers"></i> <span> Apps </span>{" "}
            ...
            <li>
              <a href="javascript: void(0);">
                <i class="fi-layout"></i>
                <span> Layouts </span> <span class="menu-arrow"></span>
              </a>
              <ul class="nav-second-level" aria-expanded="false">
                <li>
            ...
            <li>
              <a href="javascript: void(0);">
                <i class="fi-briefcase"></i> <span> UI Elements </span>{" "}
                <span class="menu-arrow"></span>
              </a>
              <ul class="nav-second-level" aria-expanded="false">
                <li>
            ...
            <li>
              <a href="javascript: void(0);">
                <i class="fi-paper"></i> <span> Tables </span>{" "}
                <span class="menu-arrow"></span>
              </a>
              <ul class="nav-second-level" aria-expanded="false">
                <li>
            ...
            <li>
              <a href="javascript: void(0);">
                <i class="fi-location-2"></i> <span> Maps </span>{" "}
                <span class="menu-arrow"></span>
              </a>
              <ul class="nav-second-level" aria-expanded="false">
                <li>
